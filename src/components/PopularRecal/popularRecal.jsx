            ...
            <SwiperSlide>
              <div className="slider">
                ...
                <div className="sliderText">
                  <h2>Ольга</h2>
                  <p>
                    Заказывали торт на свадьбу, привезли нам его прямо в кафе,
                    все были в восторге только от вида торта Вкус был
                    божественным!!!!!!. Гостям торт очень понравился, все
                    спрашивали кто делает такую красоту и вкусноту)) Большое
                    спасибо Вам! Будем теперь заказывать тортики только у Вас!))
                  </p>
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              ...
              <div className="slider">
                ...
                <div className="sliderText">
                  <h2>Максим</h2>
                  <p>
                    Как то заказывала тут набор макаронс с фотопечатью в подарок
                    и осталась очень довольна. Сервис, отношение к клиенту,
                    дизайн, вкус - все на высшем уровне! Теперь всем своим
                    друзьям и знакомым рекомендую этот магазин.
                  </p>
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              ...
              <div className="slider">
                ...
                <div className="sliderText">
                  <h2>Светлана</h2>
                  <p>
                    Большое спасибо Вам! Заказывали торт и шарики!!! Все
                    доставили во время! Подстроились под наши пожелания! Торт
                    шикарный и на вид и на вкус! Спасибо будем и впредь к Вам
                    обращаться!
                  </p>
                </div>
              </div>
              ...
              <div className="slider">
                ...
                <div className="sliderText">
                  ...
                  <p>
                    ...
                    удовольствие, заказывали торт и шарики, все очень
                    понравилось, торт был потрясающим, браво мастеру!!!!
                  </p>
                </div>
              </div>
            </SwiperSlide>{" "}
